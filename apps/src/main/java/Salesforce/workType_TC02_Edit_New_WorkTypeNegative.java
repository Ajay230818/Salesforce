...
public class workType_TC02_Edit_New_WorkTypeNegative {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.xpath("//label[@class='label inputLabel uiLabel-left form-element__label uiLabel']//span[text()='Timeframe End']//..//..//input")).sendKeys("6");

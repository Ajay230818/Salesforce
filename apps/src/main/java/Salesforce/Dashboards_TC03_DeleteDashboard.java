...
public class Dashboards_TC03_DeleteDashboard {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.xpath("//a//span[text()='Delete']")).click();
		driver.findElement(By.xpath("//button//span[text()='Delete']")).click();
		WebElement deletedashboard = driver.findElement(By.xpath("//span[@class='toastMessage slds-text-heading--small forceActionsText']"));
		deletedashboard.isDisplayed();
		driver.close();
	}
